...
$db->exec("CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT, artist TEXT)");
...
if (isset($_POST['login'])) {
  ...
  if (empty($username) || empty($password) || empty($artist)) {
    echo "Please fill in all the registration fields.";
  } else {
